...
EXPERIMENT_NAME = config.get("EXPERIMENT_NAME", "SR_UNet_SmCL")
...
def main():
    parser = argparse.ArgumentParser(
        description="Train a Super-Resolution UNet model (Hard Constrained)."
    )
    parser.add_argument(
        "--metric_loss_mode",
        type=str,
    ...
    try:
        ...
        print(f"Sampler init failed: {e}. Falling back to standard shuffling.")
