...
# ==========================================
# PART 1: Shared Mathematical Library
# ==========================================
...
# ==========================================
# MODEL 1: The Baseline ("Simple CNN")
# ==========================================
...
# ==========================================
# MODEL 2: The Theorist ("Isometric CNN")
# ==========================================


class IsometricCNN(nn.Module):
    """
    Model 2: The Theorist ("Isometric CNN") - Robust Version

    Architecture matches ConstrainedIsometricCNN (Standard Conv + MaxPool + SumPool)
    ...
    def __init__(self, n_quantiles=30, input_shape=(1, 128, 128), max_input_val=5.5):
        ...
        # Modified: Replaced CoordConv with standard Conv2d
...
# ==========================================
# MODEL 3: The Physicist ("Constrained CNN")
# ==========================================
class ConstrainedIsometricCNN(nn.Module):
    def __init__(
        self,
        n_quantiles=30,
    ...
    def forward(self, x_phys):
        ...
        # ... [Forward Pass Layers exactly as before] ...
        x = F.gelu(self.entry(x))
        x = self.pool1(x)
        x = self.res1(x)
        x = F.gelu(self.conv2(x))
