...
class ContextUnet(nn.Module):
    def __init__(
        ...
        # Structure: [Noisy_Image, LR_Precip, DEM]
        self.total_in_channels = in_channels + c_in_condition

        # --- Encoder ---
        self.inc = DoubleConv(self.total_in_channels, 64)  # Out: 64
        self.down1 = Down(64, 128)  # Out: 128
        self.down2 = Down(128, 256)  # Out: 256
        self.down3 = Down(256, 512)  # Out: 512

        # --- Bottleneck ---
        self.bot1 = DoubleConv(512, 1024)
        self.bot2 = DoubleConv(1024, 1024)
        self.bot3 = DoubleConv(1024, 512)  # Out: 512

        # --- Decoder ---
        # Up1 takes: bot3 (512) + down2 (256) = 768 channels
        self.up1 = Up(768, 256)

        # Up2 takes: up1 (256) + down1 (128) = 384 channels
        self.up2 = Up(384, 128)

        # Up3 takes: up2 (128) + inc (64) = 192 channels
        self.up3 = Up(192, 64)
